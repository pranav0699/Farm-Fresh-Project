...
function Register() {
    ...
    return (
        <div style={{backgroundImage: 'url("https://ponysfm.com/system/images/imgs/000/000/476/medium/saa_release_by_discopears-d950s13.png?1454685287")',backgroundSize: 'cover', backgroundRepeat: 'no-repeat', backgroundPosition: 'center center'}}>
